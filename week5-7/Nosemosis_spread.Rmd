...
index <- 0
winter.state <- c(Hi0=10**4, Hi1=0, Fi0=10**4, Fi1=0, Ei=0.1)
while (index < 30) {
  index <- index + 1
...
parameters.spring <- c(b=500, κ=8000, σ1=0.25, σ2=1.5, η0=0, η1=0, ϕ0=0.08511, ϕ1=0.16936, α=0.55, γ=0.2061 * 0.1, δ=0.006570, α_t=0.14, λ=10000, n=2, p=0.01, 𝜉=8, alpha=0.15)
parameters.summer <- c(b=1500, κ=12000, σ1=0.25, σ2=1.5, η0=0, η1=0, ϕ0=0.08511, ϕ1=0.16936, α=0.12, γ=0.2835 * 0.1, δ=0.023300, α_t=0.14, λ=10000, n=2, p=0.01, 𝜉=8, alpha=0.15)
parameters.fall <- c(b=500, κ=8000, σ1=0.25, σ2=1.5, η0=0, η1=0, ϕ0=0.08511, ϕ1=0.16936, α=0.24, γ=0.2527 *0.1, δ=0.015683, α_t=0.14, λ=10000, n=2, p=0.01, 𝜉=8, alpha=0.15)
...
plot(hives.ei[,1]~seq(1, nrow(hives.ei)), type="l")
```
