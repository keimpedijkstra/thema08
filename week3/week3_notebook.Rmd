...
parameters <- c(ks_Rm = 2.90, IC50_Rm = 26.2, kd_Rm = 0.612, ks_r = 3.22, Rf = 0.49, kre = 0.57, kon = 0.00329/5, kd_R = 0.0572, kT = 0.63, D = 20 )
out.first <- ode(times = times, y = y, parms = parameters, func = formula_2, method = "euler")

parameters <- c(ks_Rm = 2.90, IC50_Rm = 26.2, kd_Rm = 0.612, ks_r = 3.22, Rf = 0.49, kre = 0.57, kon = 0.00329/2, kd_R = 0.0572, kT = 0.63, D = 20 )
